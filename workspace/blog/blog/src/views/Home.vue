...
export default {
  ...
  data() {
    return {
      ...
      // 近期文章
      recentAtList: [
        { atId: 1, u_name: '谭海蓉', atDate: '2021-12-03 14:39:38', atTitle: '需求分析文档', atAbstract: '需求分析是软件一个重要的环节', atContent: '需求分析是软件一个重要的环节', atType: '文档类' },
        { atId: 2, u_name: '兰茂豪', atDate: '2021-12-03 14:39:38', atTitle: '数据库设计文档', atAbstract: '使用表连接', atContent: '使用表连接', atType: '文档类' },
        { atId: 3, u_name: '谈偲瑶', atDate: '2021-12-03 14:39:38', atTitle: 'UI设计', atAbstract: '原型图', atContent: '原型图', atType: '文档类' },
        { atId: 4, u_name: '刘晓虎', atDate: '2021-12-03 14:39:38', atTitle: '概要设计文档', atAbstract: '概要设计是', atContent: '概要设计是', atType: '文档类' },
        { atId: 5, u_name: '田晓', atDate: '2021-12-03 14:39:38', atTitle: '详细设计', atAbstract: '详细设计', atContent: '详细设计', atType: '文档类' },
      ],
      // 文章分类
      atTypeList: [
        { atType: '文学类', count: 5 },
  ...
  mounted() {
    ...
    window.onscroll = () => {
      ...
      // 如果到内容区 侧边栏跟随
      if (sy >= headerHeight + screeHeight * 0.5) {
  ...
  methods: {
    ...
    async load() {
      ...
      this.loading = true
      // 模拟异步请求
      await this.$axios.get(`/article/getPage/${this.curPageNo}/${this.maxLen}`).then((res) => {
